...
if (!hasPermission($conn, 'products', 'create') && !hasPermission($conn, 'products', 'edit')) {
    echo json_encode(['success' => false, 'message' => 'Bạn không có quyền upload ảnh sản phẩm']);
    exit;
}
...
$filename = FileUploadValidator::generateSafeFilename($file['name'], 'product_');
