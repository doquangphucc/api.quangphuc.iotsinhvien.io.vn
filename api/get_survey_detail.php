...
try {
    ...
    $formattedSurvey = [
        ...
        'results' => [
            ...
            'inverterQuantity' => isset($survey['inverter_quantity']) && $survey['inverter_quantity'] !== null ? (int)$survey['inverter_quantity'] : 1,
            'inverterTotalPrice' => isset($survey['inverter_total_price']) && $survey['inverter_total_price'] !== null ? (int)$survey['inverter_total_price'] : null,
