...
CREATE TABLE IF NOT EXISTS products (
    ...
    voltage VARCHAR(50),
    price DECIMAL(15, 2) NOT NULL COMMENT 'Giá niêm yết',
    price_installation DECIMAL(15, 2) DEFAULT NULL COMMENT 'Giá lắp đặt trọn gói',
