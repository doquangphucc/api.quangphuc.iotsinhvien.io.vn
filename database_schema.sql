...
CREATE TABLE tasks (
    ...
    scheduled_date DATE DEFAULT NULL COMMENT 'Ngày dự kiến thực hiện',
    scheduled_time TIME DEFAULT NULL COMMENT 'Giờ dự kiến thực hiện', 
...
CREATE TABLE wishes (
    ...
    user_id INT DEFAULT NULL,
    target_date DATE DEFAULT NULL COMMENT 'Ngày dự kiến mua',
    created_at DATETIME NOT NULL,
    updated_at DATETIME NOT NULL,
